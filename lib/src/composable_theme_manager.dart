...
abstract class ThemeManager {
  //TODO:
  static ThemeData _lightTheme = lightTheme;
  static ThemeData _darkTheme = lightTheme;
  ...
  static ThemeData theme([ThemeData data]) {
    if (data != null) {
      return _theme()
          .copyWith(textTheme: TextTheme(body1: data.textTheme.body1));
    } else {
      return lightTheme;
    }
  }

  //FIX ME: dark theme here
